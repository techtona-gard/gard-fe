...
class SupabaseService {
  ...
  /// Checks if user has a completed profile (height, weight, birth_date)
  ...
  /// Saves physical profile data to Supabase and local cache
  ...
  /// Saves GERD risk status after completing GerdQ questionnaire
  ...
  /// Signs out user and clears all local session data
  ...
  /// Fetches user profile from Supabase (or SharedPreferences in mock mode)
